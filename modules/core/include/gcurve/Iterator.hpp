...
template <typename CurveCirculator,typename LinkIteratorType>
Iterator<CurveCirculator,LinkIteratorType>::Iterator(LinkIteratorType itLb,
...
template <typename CurveCirculator,typename LinkIteratorType>
Iterator<CurveCirculator,LinkIteratorType>::Iterator(const Iterator& other):
            myItLb(other.myItLb),
            myItLe(other.myItLe),
            myIt1b(other.myIt1b),
            myIt1e(other.myIt1e),
...
template <typename CurveCirculator,typename LinkIteratorType>
Iterator<CurveCirculator,LinkIteratorType>& Iterator<CurveCirculator,LinkIteratorType>::operator =(const Iterator& other){
    myItLb = other.myItLb;
    myItLe = other.myItLe;
...
template <typename CurveCirculator,typename LinkIteratorType>
void Iterator<CurveCirculator,LinkIteratorType>::increment()
{
...
template <typename CurveCirculator,typename LinkIteratorType>
bool Iterator<CurveCirculator,LinkIteratorType>::equal(const Iterator& other) const
{
...
template <typename CurveCirculator,typename LinkIteratorType>
typename CurveCirculator::value_type& Iterator<CurveCirculator,LinkIteratorType>::dereference() const
{
...
template <typename CurveCirculator,typename LinkIteratorType>
void Iterator<CurveCirculator,LinkIteratorType>::decrement()
{
    if( iteratorStage==0 || iteratorStage==2 ){
        if( iteratorStage==2 ) {
